...
const resources = [
  ...
  },
  {
    type: "Guide",
    icon: BookOpen,
    title: "The MSP's Guide to Recurring Revenue",
    description: "How to build a profitable cloud backup practice with Druva.",
    downloadUrl: "#",
  },
  {
    type: "Whitepaper",
    icon: FileText,
    title: "Air-Gapped Backups: The Complete Guide",
    description: "Understanding logical air-gapping and immutable storage.",
    downloadUrl: "#",
  },
];
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-white mt-2 mb-4">
                  The 2025 Ransomware Resilience Playbook
                </h2>
                <p className="text-brand-text mb-6">
                  A comprehensive guide to building an unstoppable recovery strategy.
                  Learn how to implement air-gapped backups, automate threat detection,
                  and achieve sub-4-hour recovery times.
                </p>
            ...
            >
              <Card className="h-full flex flex-col">
                <div className="flex items-center gap-2 mb-4">
                  <resource.icon className="h-5 w-5 text-brand-accent" />
                ...
                <Link href={resource.downloadUrl} className="inline-flex items-center text-brand-accent hover:text-brand-accent/80 text-sm font-medium">
                  Download

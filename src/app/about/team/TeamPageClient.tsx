...
const defaultMembers: TeamMember[] = [
  {
    ...
    bio: "With over 25 years in enterprise IT, David founded iNovuus Technologies to bring world-class data protection solutions to Singapore.",
  ...
  },
  {
    ...
    bio: "Sarah leads our technical strategy, bringing 18 years of experience in cloud infrastructure and cybersecurity.",
    linkedin: "https://linkedin.com/in/",
  ...
  },
  {
    ...
    bio: "Michael oversees solution architecture and client implementations, ensuring every deployment meets the highest standards.",
    linkedin: "https://linkedin.com/in/",
  ...
  },
  {
    ...
    bio: "Jennifer specializes in designing tailored data protection strategies for enterprise clients.",
    linkedin: "https://linkedin.com/in/",
            ...
            >
              <Card className="h-full group hover:shadow-lg hover:shadow-brand-accent/10 transition-all duration-300">
                ...
                <div className="relative mb-4">
                  <div className="w-full aspect-square bg-gradient-to-br from-brand-dark to-brand-navy rounded-lg flex items-center justify-center border border-brand-slate/30 group-hover:border-brand-accent/50 transition-colors duration-300 overflow-hidden">
                    {member.image?.url ? (
                      <Image
